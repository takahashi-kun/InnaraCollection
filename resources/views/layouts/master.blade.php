...
<head>
  ...
  <link rel="shortcut icon" href="{{ asset ('build/assets/images/cropped_circle_image_ico.ico') }}" type="image/x-icon">
...
<body class="gradient-bg">
  ...
  <div class="header-mobile header_sticky">
    <div class="container d-flex align-items-center h-100">
      ...
      <div class="logo">
        <a href="{{ route('login') }}">
          <img src="{{asset('build/assets/images/cropped_circle_image_png.png')}}" alt="Uomo" class="logo__image d-block" />
        </a>
      </div>
